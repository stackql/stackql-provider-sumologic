...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.slos.copy" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#slosCopy"><CopyableCode code="slosCopy" /></a></td>
...
<tr id="parameter-id">
    ...
    <td>Identifier of the slo or folder to copy.</td>
</tr>
...
<Tabs
    defaultValue="slosCopy"
    values={[
        { label: 'slosCopy', value: 'slosCopy' }
    ]}
>
<TabItem value="slosCopy">

Copy a slo or folder in the slos library.

```sql
EXEC sumologic.slos.copy.slosCopy 
@id='{{ id }}' --required, 
