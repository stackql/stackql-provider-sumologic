...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.slos.export" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#slosExportItem"><CopyableCode code="slosExportItem" /></a></td>
...
<Tabs
    defaultValue="slosExportItem"
    values={[
        { label: 'slosExportItem', value: 'slosExportItem' }
    ]}
>
<TabItem value="slosExportItem">
...
```sql
EXEC sumologic.slos.export.slosExportItem 
@id='{{ id }}' --required, 
