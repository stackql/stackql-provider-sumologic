...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.monitors.export" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#monitorsExportItem"><CopyableCode code="monitorsExportItem" /></a></td>
...
<Tabs
    defaultValue="monitorsExportItem"
    values={[
        { label: 'monitorsExportItem', value: 'monitorsExportItem' }
    ]}
>
<TabItem value="monitorsExportItem">
...
```sql
EXEC sumologic.monitors.export.monitorsExportItem 
@id='{{ id }}' --required, 
