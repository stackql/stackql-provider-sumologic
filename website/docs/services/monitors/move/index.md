...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.monitors.move" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#monitorsMove"><CopyableCode code="monitorsMove" /></a></td>
...
<tr id="parameter-id">
    ...
    <td>Identifier of the monitor or folder to move.</td>
</tr>
<tr id="parameter-parentId">
    <td><CopyableCode code="parentId" /></td>
    <td><code>string</code></td>
    <td>Identifier of the parent folder to move the monitor or folder to.</td>
</tr>
...
<Tabs
    defaultValue="monitorsMove"
    values={[
        { label: 'monitorsMove', value: 'monitorsMove' }
    ]}
>
<TabItem value="monitorsMove">

Move a monitor or folder to a different location in the monitors library.

```sql
EXEC sumologic.monitors.move.monitorsMove 
@id='{{ id }}' --required, 
