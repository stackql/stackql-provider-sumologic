...
<tr><td><b>Id</b></td><td><CopyableCode code="sumologic.fields.disable" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#disableField"><CopyableCode code="disableField" /></a></td>
...
<Tabs
    defaultValue="disableField"
    values={[
        { label: 'disableField', value: 'disableField' }
    ]}
>
<TabItem value="disableField">
...
```sql
EXEC sumologic.fields.disable.disableField 
@id='{{ id }}' --required, 
